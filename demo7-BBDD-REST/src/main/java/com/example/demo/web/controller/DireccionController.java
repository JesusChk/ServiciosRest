...
public class DireccionController {
	...
	public ModelAndView findAllByCliente(@PathVariable Long idCliente) {
		...
		log.info("DireccioneController - findAllByCliente: Listamos las direcciones del cliente: " + idCliente);

		// Obtenemos el cliente para poner sus datos en la pantalla
	...
	public ModelAndView save(@PathVariable Long idCliente, @ModelAttribute("direccionDTO") DireccionDTO direccionDTO) {
		...
		log.info("DireccioneController - Save: Almacenamos la  direccion: " + direccionDTO.toString());
		...
		/*//Anyadimos al cliente la direccion. Puede tener direcciones el clienteDTO
		clienteDTO.getListaDireccionesDTO().add(direccionDTO);*/
		
		//Anyadimos a la direccion el cliente. Esta direccion solo tiene este cliente ya que es una direccion nueva
		//Pero el cliente ahora ya tiene la direccion nueva en su lista
		direccionDTO.getListaClientesDTO().add(clienteDTO);
		direccionService.save(direccionDTO);

		// Redireccionamos para volver a clientes direcciones
	...
	public ModelAndView add(@PathVariable Long idCliente) {
		...
		log.info("DireccioneController - Add: Anyadimos una nueva direccion al cliente: " + idCliente);
